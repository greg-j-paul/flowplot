...
#' @param spacing: a number controlling the spacing of nodes defaults to 2
#' @param colorset: a parameter controlling which of the Rcolorbrewer colorsets to use
#' @keywords RiverPlot
#' @export
#' @examples
#' edges = data.frame(N1 = paste0(rep(LETTERS[1:4], each = 4), rep(1:5, each = 16)),
...
plotflows <- function( edges, spacing = 2, colorset = "Set1" ){
  library(stringi)
  library(stringi)
